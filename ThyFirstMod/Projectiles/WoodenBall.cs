...
{
	public class WoodenBall : ModProjectile
	{
		// The folder path to the flail chain sprite
		private const string ChainTexturePath = "ThyFirstMod/Projectiles/Chain";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("WoodenBall"); // Set the projectile name to Example Flail Ball
		}
